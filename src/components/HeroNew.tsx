        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[600px] py-12">
          <div className="space-y-8">
            ...
            <div className="flex font-medium flex-col sm:flex-row gap-4">
              ...
              <button className="btn-muted">Learn More</button>
            </div>
          ...
          <div className="relative">
            ...
            <div className="absolute bg-white -top-4 -left-4 rounded-lg shadow-2xl p-4 transform rotate-[-5deg] hover:rotate-0 transition-transform duration-300">
            ...
            <div className="absolute text-white bg-green-600 -bottom-4 -right-4  rounded-lg shadow-2xl p-4 transform rotate-[5deg] hover:rotate-0 transition-transform duration-300">
